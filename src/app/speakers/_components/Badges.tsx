export function VerifiedBadge() {
  return (
    <span
      ...
      className="inline-flex items-center gap-1 rounded-full bg-wbv-accent/15 px-2 py-0.5 text-[11px] font-medium text-wbv-secondary"
    >
      <svg viewBox="0 0 20 20" aria-hidden="true" className="h-3 w-3 fill-wbv-accent">
        <path
          fillRule="evenodd"
